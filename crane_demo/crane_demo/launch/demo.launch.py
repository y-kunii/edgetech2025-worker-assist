...
def generate_launch_description():
    ...
    declare_demo_name = DeclareLaunchArgument(
        'demo', default_value='gripper_control',
        description=('Set an demo executable name: '
#                     '[gripper_control, pose_groupstate, joint_values, pick_and_place]')
                     '[pick_and_place, pick_and_place_with_pos]')
    )
    ...
    demo_node = Node(name=[LaunchConfiguration('demo'), '_node'],
                        package='crane_plus_demo',
